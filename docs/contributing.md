...
2. Record the change in the decision log if it affects project direction.
3. Update the sources index if new references were used.
4. Validate links, wording, and consistency.
